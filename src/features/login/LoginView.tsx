        ...
        <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden px-5">
            ...
            >
                    ...
                    <div className="relative z-10 p-7">
                        ...
                        <div className="mt-6 pt-5 border-t border-stone-100 text-center">
                            <button
                                ...
                                className="text-xs font-medium text-stone-500 hover:text-stone-800 transition-colors flex items-center justify-center gap-2 mx-auto group"
                            >
                                <span>Continue as Guest</span>
                                <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
                            </button>
                            <p className="text-[10px] text-stone-400 mt-2">No account needed • Limited features</p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <p className="text-[10px] text-stone-400/60 mt-1 flex items-center justify-center gap-1">
